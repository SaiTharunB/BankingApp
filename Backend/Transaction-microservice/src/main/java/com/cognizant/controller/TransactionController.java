...
public class TransactionController {
	...
	public TransactionStatus makeTransfer(@RequestHeader("Authorization") String auth,@Valid @RequestBody TransactionInput transactionInput) {
		log.info("inside transaction method");
boolean status = transactionService.makeTransfer(auth, transactionInput);
